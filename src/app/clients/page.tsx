          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-slate-100">
                ...
                <th className="text-left px-4 py-3 text-xs font-medium text-slate-500">狀態</th>
              </tr>
            </thead>
              ...
              {clients.map((client) => (
                ...
                >
                  ...
                  <td className="px-4 py-3 text-slate-600">
                    {client.gender || "—"}
                    {client.birthDate &&
                      ` / ${calculateAge(client.birthDate)} 歲`}
                  </td>
                  <td className="px-4 py-3 text-slate-600">
                  ...
                  <td className="px-4 py-3">
                    <div className="flex items-center gap-1.5">
                      <Badge variant="info">
                        {client._count.consultations} 次諮詢
                      </Badge>
                      {client._count.tasks > 0 && (
                        <Badge variant="warning">
                          {client._count.tasks} 任務
                        </Badge>
                      )}
                    </div>
                  </td>
